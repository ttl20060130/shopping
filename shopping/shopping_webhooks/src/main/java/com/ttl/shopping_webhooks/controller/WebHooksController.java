package com.ttl.shopping_webhooks.controller;

import com.ttl.shopping_common.service.MailService;
import com.ttl.shopping_webhooks.dto.AlarmMessageDto;
...
//        System.out.println(builder.toString());
         ...
         * 此处同学们给自己的邮箱发送告警信息即可
         */
        mailService.sendMail("461618768@qq.com",builder.toString(),"注意!晨曦商城项目告警!");
    }
}